...
| 9. Replace MEGNet with M3GNet and TensorNet | 4/4 | Complete | 2026-03-08 |
...
- [x] 09-03-PLAN.md -- Evaluation, dashboard, and documentation updates (metrics, plots, model_loader, README)
- [x] 09-04-PLAN.md -- Tests (test_m3gnet.py, test_tensornet.py), integration test updates, MEGNet file deletion
